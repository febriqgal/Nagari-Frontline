...
class TextStylesApp {
  static const TextStyle text3xs = TextStyle(fontSize: 6);
  static const TextStyle text2xs = TextStyle(fontSize: 8);
  static const TextStyle text1xs = TextStyle(fontSize: 10);
  static const TextStyle textXs = TextStyle(fontSize: 12);
  static const TextStyle textBase = TextStyle(fontSize: 14);
  static const TextStyle textSm = TextStyle(fontSize: 16);
  ...
  static const TextStyle text6xl = TextStyle(fontSize: 60);
}
